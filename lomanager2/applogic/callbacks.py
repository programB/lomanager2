...
# progress_reporter = UnifiedProgressReporter(total_steps=X, callbacks=kwargs)
# progress_reporter.step_start()
# progress_reporter.step_skip()
# progress_reporter.step_end()
# progress_reporter.progress(int)
# progress_reporter.progress_msg(int)
